// ============================================
// Sync Client (local copy — kept in sync with /shared/sync-client.js)
// ============================================
//
// Why this file exists as a local copy rather than a require from ../../../shared:
// electron-builder only bundles files inside the app's own folder when packaging.
// Requiring a file from a sibling directory works in `npm run dev` but breaks in
// the packaged .app with "Cannot find module '../../../shared/sync-client'".
//
// If you change shared/sync-client.js, copy the new version here too.
// ============================================
